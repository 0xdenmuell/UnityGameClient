...
/*
 * This class takes care of the distribution of threads.
 * In Unity, threads are treated differently than normal, because certain calculations 
 * must be handled in the so-called main thread.
