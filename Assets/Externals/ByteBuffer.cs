...
/*
 * This class takes care of converting datatypes (int, string, bool) to bits and the other way round. 
 * Mainly the functions are used for communication between server and client and the other way round.
 */
